...
const steps: StepProps[] = [
  {
    ...
    description:
      "Profiles are independent workspaces that represent different career personas or job search strategies.",
    icon: <UserPlus className="h-5 w-5 text-primary" />,
    details: [
      "Go to the Dashboard and click \"New Profile\".",
      "Give it a name (e.g. \"Backend Engineer\", \"Architect\").",
      "Add your target job titles, skills, and any constraints (e.g. location, remote-only).",
      "Optionally upload your CV (PDF supported) so the system can extract skills automatically.",
    ],
